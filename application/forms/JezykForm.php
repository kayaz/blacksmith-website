...
class Form_JezykForm extends Zend_Form
{
    public function __construct($options = null)
    {
        ...
        $homepage_about = new Zend_Form_Element_Textarea('homepage_about');
        $homepage_about->setLabel('Strona główna - O mnie')
            ->setRequired(true)
            ->setAttrib('rows', 17)
            ->setAttrib('cols', 100)
        ...
        $homepage_paralaxa = new Zend_Form_Element_Textarea('homepage_paralaxa');
        $homepage_paralaxa->setLabel('Strona główna - Paralaxa')
            ->setRequired(true)
            ->setAttrib('rows', 17)
            ->setAttrib('cols', 100)
            ->setAttrib('class', 'minieditor')
