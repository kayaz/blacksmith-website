<?php
class Form_NazwaSubPlikForm extends Zend_Form
{ 
    public function __construct($options = null)
    {
        ...
        $subnazwa = new Zend_Form_Element_Text('subnazwa');
        $subnazwa->setLabel('Sub-nazwa')
		->setRequired(true)
		->setAttrib('size', 83)
		->setAttrib('class', 'validate[required]')
		->addValidator('NotEmpty')
        ...
        $this->addElements(array($nazwa, $subnazwa, $obrazek, $submit));
    }
}